...
const pageSignals = [
  ...
  {
    label: "대표 내부 링크",
    value: "영등포 대표 페이지, 예약 가이드, 예약문의 페이지",
  },
  {
    label: "답변 방식",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "서울 전체 문서는 넓은 검색 의도에 대응하고, 상세 지역 페이지는 영등포·강남처럼 구체적인 지역 의도에 대응하기 위해 분리합니다. 이렇게 문서 역할을 나누면 검색엔진이 각 페이지의 주제를 더 쉽게 이해하고, 내부 링크 구조도 훨씬 명확해집니다.",
  },
  {
      ...
      <div className="content-block">
        ...
        <section className="page-article__section">
          ...
          <p className="page-article__section-body">
            ...
            사용자 입장에서는 먼저 서울 전체 흐름을 이해하고, 검색엔진과 AI 입장에서는 서울 문서와 세부 지역 문서의 역할을 더 쉽게 구분할 수 있습니다.
          </p>
        </section>
      </div>
    </article>
