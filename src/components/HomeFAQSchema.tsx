...
export const FAQ_ITEMS: { question: string; answer: string }[] = [
  {
    ...
    answer:
      "홈에서는 브랜드와 전체 구조를 먼저 확인하면 됩니다. 현재는 영등포 대표 지역 페이지를 우선 운영하고 있어, 지역 검색 의도가 분명하면 해당 대표 페이지로 바로 이동하는 흐름이 가장 자연스럽습니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "현재는 서울 권역 안에서 영등포 생활권 대표 페이지를 먼저 운영하고 있습니다. 이후 다른 지역이 추가되면 서울 페이지 아래에 같은 구조로 계속 확장할 수 있도록 맞춰 두었습니다.",
  },
  {
