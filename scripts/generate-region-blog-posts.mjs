/**
 * 지역별 출장마사지 블로그 초안 생성 — 실행: node scripts/generate-region-blog-posts.mjs
...
/** @type {{ slug: string; title: string; desc: string; tags: [string,string,string,string]; hints: string[] }[]} */
const posts = [
  // 서울
  {
    ...
    hints: ["테헤란로·역삼역 인근 오피스", "신논현·강남역 상권", "청담동 주거·카페거리", "압구정·신사동 일대"],
  },
  {
    ...
    hints: ["마곡나루·발산역 신축 단지", "김포공항 인근 숙소", "화곡·우장산 주거지", "등촌·염창 일대"],
  },
  // 전북
  {
    ...
    hints: ["한옥마을·교동 일대", "혁신도시·송천", "덕진공원 인근", "효자동 주거지"],
  },
  {
    ...
    hints: ["익산역·시청 인근", "모현·어양 신도시", "영등·동산동", "팔봉동 일대"],
  },
  {
    ...
    hints: ["군산산단 출퇴근", "내항·소룡동", "조촌·미룡동", "경포대 인근"],
  },
  // 경기 — 시·군별 (태그 전부 유일)
  {
    ...
    hints: ["영통·망포 신도시", "수원역·팔달문", "권선·서수원", "장안·율전"],
  },
  {
    ...
    hints: ["판교·정자 일대", "수정구 태평·복정", "중원구 성남동", "야탑·이매역"],
  },
  {
    ...
    hints: ["일산·백석·마두", "덕양 삼송·원흥", "행신·화정", "킨텍스 인근"],
  },
  {
    ...
    hints: ["수지·죽전", "기흥·동백", "에버랜드 인근 처인", "용인터미널"],
  },
  {
    ...
    hints: ["상동·중동", "소사역 인근", "오정구 원종동", "부천시청"],
  },
  {
  ...
  },
  {
    ...
    hints: ["고잔·중앙동", "본오·사동", "선부·원곡", "시화산단 인근"],
  },
  {
    ...
    hints: ["별내·호평", "다산·도농", "와부·금곡", "진접·퇴계원"],
  },
  {
  ...
  },
  {
    ...
    hints: ["평택역·비전", "송탄·서정리", "안중·포승", "고덕신도시"],
  },
  {
    ...
    hints: ["의정부역·시청", "회룡·송산", "가능·호원", "신곡·의정부경전철"],
  },
  {
    ...
    hints: ["배곧·은행", "정왕·시화", "오이도·월곶", "군자·능곡"],
  },
  {
    ...
    hints: ["운정신도시", "금촌·아울렛", "교하·문산", "탄현·월롱"],
  },
  {
  ...
  },
  {
    ...
    hints: ["오산역·대원동", "세마·원동", "초평·수청", "동탄 인접"],
  },
  {
  ...
  },
  {
    ...
    hints: ["왕곡·포일", "고천·오전", "내손·청계", "백운호수 인근"],
  },
  {
    ...
    hints: ["옥정신도시", "덕정·양주역", "회천·광적", "장흥·은현"],
  },
  {
  ...
  },
  {
    ...
    hints: ["중앙·갈현", "별양·부림", "문원·과천정부", "대공원역"],
  },
  {
...
function sectionsFor(p) {
  const [a, b, c, d] = p.hints;
  const head = p.title.split("—")[0].trim();
  const place = head.replace(/\s*출장마사지\s*$/u, "").trim() || head;
  return [
    {
      title: `${place}에서 출장마사지를 찾는 흐름`,
      paragraphs: [
        `${a}·${b} 일대는 주거와 상업이 섞여 출장마사지 문의가 꾸준합니다. 집이나 오피스텔에서 받으면 이동 없이 이완 후 바로 휴식으로 이어질 수 있습니다.`,
        `${c}·${d} 방향은 도로 상황에 따라 도착 시각이 달라질 수 있어, 예약 시 구·동·단지명까지 알려주시면 안내가 정확해집니다. 이 사이트는 서울·경기·인천 등 문의 시 가능 지역을 함께 안내합니다.`,
      ],
    },
    {
    ...
    },
    {
      title: "정리",
      paragraphs: [
        `${place}에 거주하거나 단기 체류 중이시라면, 전화·메신저로 가능 여부와 희망 시간을 알려주시면 안내해 드립니다. 지역·동선을 알려주실수록 예약 시간 맞추기가 수월합니다.`,
      ],
    },
  ];
}
